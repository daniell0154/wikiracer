...
function buildWikiPage(html, title, sections, isDark) {
  var wikiCSS = '<style>' +
    'body { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, sans-serif; background: ' + (isDark ? '#202122' : '#fff') + '; color: ' + (isDark ? '#eaecf0' : '#202122') + '; padding: 20px 24px; max-width: 960px; margin: 0 auto; line-height: 1.6; font-size: 14px; }' +
    'a { color: ' + (isDark ? '#8ab4f8' : '#0645ad') + '; text-decoration: none; } a:hover { text-decoration: underline; } a:visited { color: ' + (isDark ? '#c5a7e8' : '#0b0080') + '; } a.new { color: #ff8080; } a.external { color: ' + (isDark ? '#8ab4f8' : '#36b') + '; }' +
    'h1, h2, h3, h4, h5, h6 { font-family: "Linux Libertine", "Georgia", "Times", serif; color: ' + (isDark ? '#eaecf0' : '#202122') + '; line-height: 1.3; margin: 0; padding: 0; }' +
    ...
    'table.infobox { background: ' + (isDark ? '#27292d' : '#f8f9fa') + '; border: 1px solid ' + (isDark ? '#54595d' : '#a2a9b1') + '; border-collapse: collapse; float: right; margin: 0 0 1em 1em; width: auto; max-width: 320px; font-size: 12.5px; line-height: 1.4; clear: right; }' +
    ...
    'table.infobox th { background: ' + (isDark ? '#34373d' : '#eaecf0') + '; font-weight: 600; text-align: left; }' +
    'table.infobox .infobox-header { background: #ddd; font-weight: 700; text-align: center; }' +
    'table.wikitable { background: ' + (isDark ? '#27292d' : '#f8f9fa') + '; border: 1px solid ' + (isDark ? '#54595d' : '#a2a9b1') + '; border-collapse: collapse; margin: 1em 0; font-size: 13px; }' +
    'table.wikitable caption { font-size: 14px; font-weight: 700; padding: 0.4em; text-align: center; background: ' + (isDark ? '#34373d' : '#eaecf0') + '; }' +
    'table.wikitable th, table.wikitable td { padding: 0.4em 0.6em; border: 1px solid #a2a9b1; vertical-align: top; }' +
    'table.wikitable th { background: ' + (isDark ? '#34373d' : '#eaecf0') + '; font-weight: 600; text-align: left; }' +
    'table.wikitable tr:hover { background: ' + (isDark ? '#34373d' : '#f0f0f0') + '; }' +
    ...
    'table:not(.infobox):not(.wikitable):not(.navbox):not(.sidebar) th { background: ' + (isDark ? '#34373d' : '#eaecf0') + '; font-weight: 600; }' +
    ...
    'blockquote { border-left: 3px solid #a2a9b1; margin: 0.5em 0; padding: 0.3em 1em; background: ' + (isDark ? '#27292d' : '#f8f9fa') + '; font-style: italic; }' +
